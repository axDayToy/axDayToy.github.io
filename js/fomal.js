...
$.ajax({
  ...
  data: {
    key: 'P7PBZ-6FH3T-KJAXK-VQSJD-LHI4J-3HF3K',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function share_() {
  ...
  try {
    ...
    navigator.clipboard.writeText('阿羡空间站的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (m == 11 && dd == 24) {//站长生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝站长" + (y - 1995).toString() + "岁生日快乐！🥝");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
if (m == 6 && dd == 30) {//小猫咪生日
...
function createtime() {
  ...
  var grt = new Date("03/031/2023 00:00:00");	// 网站诞生时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
    ? `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i>`
    : `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i>`,
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://bu.dusays.com/2024/06/05/6660549004b4e.webp);
    --darkmode-bg:url(https://bu.dusays.com/2024/06/05/6660546ba561e.webp);
    --mobileday-bg: url(https://bu.dusays.com/2024/06/05/666054fef1e4f.webp);
    --mobilenight-bg: url(https://bu.dusays.com/2024/06/05/666054eb4a6aa.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://bu.dusays.com/2024/06/05/666054b6d842c.webp)" class="imgbox" onclick="changeBg('url(https://bu.dusays.com/2024/06/05/666054b6d842c.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://bu.dusays.com/2024/06/05/66605491c03de.webp)" class="imgbox" onclick="changeBg('url(https://bu.dusays.com/2024/06/05/66605491c03de.webp))')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://bu.dusays.com/2024/06/05/666054b60f58d.webp)" class="imgbox" onclick="changeBg('url(https://bu.dusays.com/2024/06/05/666054b60f58d.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://bu.dusays.com/2024/06/05/666054d083897.webp)" class="pimgbox" onclick="changeBg('url(https://bu.dusays.com/2024/06/05/666054d083897.webp)')"></a></div>
              </div>
            </details>
